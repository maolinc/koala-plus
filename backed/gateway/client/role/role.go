...
func (m *defaultRole) CreateRole(ctx context.Context, in *RoleReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewRoleClient(m.cli.Conn())
	return client.CreateRole(ctx, in, opts...)
}

func (m *defaultRole) UpdateRole(ctx context.Context, in *RoleReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewRoleClient(m.cli.Conn())
	return client.UpdateRole(ctx, in, opts...)
}

func (m *defaultRole) DeleteRole(ctx context.Context, in *DeletesReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewRoleClient(m.cli.Conn())
	return client.DeleteRole(ctx, in, opts...)
}

func (m *defaultRole) PageRole(ctx context.Context, in *RoleQueryReq, opts ...grpc.CallOption) (*RoleListResp, error) {
	client := pb.NewRoleClient(m.cli.Conn())
