...
func (m *defaultDept) CreateDept(ctx context.Context, in *DeptReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewDeptClient(m.cli.Conn())
	return client.CreateDept(ctx, in, opts...)
}

func (m *defaultDept) UpdateDept(ctx context.Context, in *DeptReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewDeptClient(m.cli.Conn())
	return client.UpdateDept(ctx, in, opts...)
}

func (m *defaultDept) DeleteDept(ctx context.Context, in *DeletesReq, opts ...grpc.CallOption) (*EmptyResp, error) {
	client := pb.NewDeptClient(m.cli.Conn())
	return client.DeleteDept(ctx, in, opts...)
}

func (m *defaultDept) PageDept(ctx context.Context, in *DeptQueryReq, opts ...grpc.CallOption) (*DeptListResp, error) {
	client := pb.NewDeptClient(m.cli.Conn())
